...
const STATUS_CONTENT_MAP = {
    succeeded: {
        text: "Pagamento efetuado com sucesso. Obrigao!",
        iconColor: "#30B130",
        icon: SuccessIcon,
...
export function CompletePayment() {
    ...
    return (
        <div className="container">
            ...
            <Container>
                <h2 id="title">Checkout - Pedido Concluído</h2>
                <div id="payment-status">
                    ...
                    {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`}
                        id="view-details" rel="noopener noreferrer" target="_blank">
                        Ver detalhes
